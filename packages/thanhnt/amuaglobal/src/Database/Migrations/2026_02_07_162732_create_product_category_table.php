...
return new class extends Migration
{
	...
	public function up(): void
	{
		Schema::create(ProductInterface::R_PRODUCT_CATEGORY_TABLE, function (Blueprint $table) {
			...
			$table->foreignId(ProductInterface::R_PRODUCT_CATEGORY_CATEGORY_ID)->constrained(\Thanhnt\Amuaglobal\Models\Types\CategoryInterface::TABLE_NAME)->onDelete('cascade');
		});
	}
