...
interface ProductInterface
{
	...
	const R_PRODUCT_CATEGORY_TABLE = 'amua_product_category';
	...
	const FORM_FIELDS = [
		...
		['key' => CategoryInterface::_PARENT_ID, 'type' => FormFieldInterface::TYPE_SELECT_CHECKBOX, 'options_source' => \Thanhnt\Amuaglobal\Models\Category::class, 'placeholder' => 'Danh mục', 'label' => 'Danh mục'],
