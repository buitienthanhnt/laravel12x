...
use Thanhnt\Amuaglobal\Models\ShareAction\{ActiveAttr, AliasAttr, ImagePath};
use Thanhnt\Amuaglobal\Models\Types\{AttributeInterface, GalleryInterface, PriceInterface, ProductInterface, StockInterface};
...
final class Product extends Model implements ProductInterface
{
	 ...
	 * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Thanhnt\Amuaglobal\Models\Attribute, $this>
	 */
	 ...
	 * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Thanhnt\Amuaglobal\Models\Gallery, $this>
	 */
	 ...
	 * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany<\Thanhnt\Amuaglobal\Models\Category, $this>
	 */
	public function category()
	{
		/**
		 * define relation many to many with table product_category
		 * @var \Illuminate\Database\Eloquent\Relations\BelongsToMany<\Thanhnt\Amuaglobal\Models\Category, $this>
	 ...
	 * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Thanhnt\Amuaglobal\Models\Price, $this>
	 */
	 ...
	 * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Thanhnt\Amuaglobal\Models\Stock, $this>
	 */
