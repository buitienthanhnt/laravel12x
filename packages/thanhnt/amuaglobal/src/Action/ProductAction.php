...
use Thanhnt\Amuaglobal\Events\ProductRegisterEvent;
use Thanhnt\Amuaglobal\Models\Product;
use Thanhnt\Amuaglobal\Models\ShareAction\FormData;
use Thanhnt\Amuaglobal\Models\Types\{ProductInterface, CategoryInterface, PriceInterface, GalleryInterface, StockInterface};
...
final class ProductAction
{
	...
	public function execute(RegisterProduct $request)
	{
		 ...
		 * @var \Thanhnt\Amuaglobal\Events\ProductRegisterEvent
		 */
