...
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:26
...
/**
* @see \Thanhnt\Akhoglobal\Controllers\Adminhtml\BlockAdminController::groupDetail
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:43
* @route '/adminhtml/block/group/{id}'
*/
export const groupDetail = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: groupDetail.url(args, options),
    method: 'get',
})

groupDetail.definition = {
    methods: ["get","head"],
    url: '/adminhtml/block/group/{id}',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/adminhtml/block/group/{id}'
*/
groupDetail.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return groupDetail.definition.url
...
* @route '/adminhtml/block/group/{id}'
*/
groupDetail.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: groupDetail.url(args, options),
    method: 'get',
})
...
* @route '/adminhtml/block/group/{id}'
*/
groupDetail.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: groupDetail.url(args, options),
    method: 'head',
})
...
* @route '/adminhtml/block/group/{id}'
*/
const groupDetailForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: groupDetail.url(args, options),
    method: 'get',
})
...
* @route '/adminhtml/block/group/{id}'
*/
groupDetailForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: groupDetail.url(args, options),
    method: 'get',
})
...
* @route '/adminhtml/block/group/{id}'
*/
groupDetailForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: groupDetail.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
groupDetail.form = groupDetailForm
...
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:79
...
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:86
...
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:114
...
* @see packages/thanhnt/akhoglobal/src/Controllers/Adminhtml/BlockAdminController.php:125
...
const BlockAdminController = { blockList, groupDetail, addBlock, deleteBlock, updateBlock, addBlockItem, deleteBlockItem }
