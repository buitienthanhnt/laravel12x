...
/**
* @see \Thanhnt\Amuaglobal\Controllers\Frontend\CategoryController::detailCategory
* @see packages/thanhnt/amuaglobal/src/Controllers/Frontend/CategoryController.php:22
* @route '/{id}.htm'
*/
