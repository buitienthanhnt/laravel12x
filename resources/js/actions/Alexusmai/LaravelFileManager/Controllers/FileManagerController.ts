...
const FileManagerController = { initialize, content, tree, selectDisk, upload, deleteMethod, paste, rename, download, thumbnails, preview, url, createDirectory, createFile, updateFile, streamFile, zip, unzip, ckeditor, tinymce, tinymce5, summernote, fmButton, delete: deleteMethod }
